...
variable.shutterSpeed          = Exposure Time
...
metadata.field.name.EXPOSURE_TIME = EXPOSURE TIME
...
##############################################################################################################
findimage.categories.label                                = CATEGORIES
findimage.categories.andRadioButton.label                 = AND
findimage.categories.andRadioButton.tooltip               = <html>An image must have all the selected categories<br/>assigned to be added to the search result.</html>
findimage.categories.orRadioButton.label                  = OR
findimage.categories.orRadioButton.tooltip                = <html>An image may have any combination of the selected<br/>categories assigned to be added to the search result.</html>
findimage.categories.clearCategoriesSelectionButton.label = Clear selected categories
...
findimage.rating.label.unrated = UNRATED
findimage.rating.tooltip.bad   = Bad
findimage.rating.tooltip.good  = Good
findimage.comment.label              = COMMENT
findimage.comment.defaultCommentText = Add Comment Here

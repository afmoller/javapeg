...
public class RenameProcessContext {
     ...
     */
    private final Map<File, File> jPEGOriginalFilePathConvertedFileObjectMapping;


    private final Map<File, File> jPEGOriginalFilePathThumbNailFileObjectMapping;
     ...
     * in the value field.
     */
    private final Map<File, FileAndType> nonJPEGOriginalFilePathDestinationFileObjectMapping;

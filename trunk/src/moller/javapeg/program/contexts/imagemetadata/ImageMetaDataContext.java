...
public class ImageMetaDataContext {
	 ...
	 */
	private final Map<String, Set<Integer>> cameraModels;
	private final Map<String, Set<Integer>> dateTimeValues;

	private final Map<Integer, Set<Integer>> yearValues;
	private final Map<Integer, Set<Integer>> monthValues;
	private final Map<Integer, Set<Integer>> dateValues;
	private final Map<Integer, Set<Integer>> hourValues;
	private final Map<Integer, Set<Integer>> minuteValues;
	private final Map<Integer, Set<Integer>> secondValues;

	private final Map<Integer, Set<Integer>> isoValues;
	private final Map<String, Set<Integer>> imageSizeValues;
	private final Map<String, Set<Integer>> exposureTimeValues;
	private final Map<Double, Set<Integer>> fNumberValues;

	private final List<Set<Integer>> ratings;
	private final Map<String, Map<String, Set<Integer>>> javaPegIdToCategories;
	private final Map<String, Set<Integer>> comments;
	...
	public Set<File> findImagesByJavaPegIdToCategoriesMap(Map<String, Categories> javaPegIdToCategoriesMap, Map<String, Boolean> importedCategoriesSearch) {
	    Set<File> imagePaths = new HashSet<File>();

	    for (String javaPegId : javaPegIdToCategoriesMap.keySet()) {
	        imagePaths.addAll(findImagesByCategory(javaPegId, javaPegIdToCategoriesMap.get(javaPegId), importedCategoriesSearch.get(javaPegId)));
	    }
	    return imagePaths;
    }

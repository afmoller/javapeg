...
public class ImageResizer extends JavaPEGBaseFrame {
    ...
    private class IntegerDocumentFilter extends DocumentFilter {
        ...
        @Override
        public void insertString(FilterBypass fp, int offset, String string, AttributeSet aset) throws BadLocationException {
            fp.insertString(offset, string.replaceAll(NON_INTEGER_REGEXP, ""), aset);
        }

        @Override
        public void replace(FilterBypass fp, int offset, int length, String string, AttributeSet aset) throws BadLocationException {
            fp.insertString(offset, string.replaceAll(NON_INTEGER_REGEXP, ""), aset);
        }
    }

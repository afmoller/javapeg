...
public class C {
    ...
    public final static String ICONFILEPATH = "/images/";
    ...
    public final static String PATH_SCHEMAS = "/schema/";
    public final static String PATH_SCHEMA_META_DATA = "/schema/metadata/";
}

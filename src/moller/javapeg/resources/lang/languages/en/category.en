...
category.categoriesModel.repositoryExists       = Image Repository path exists.
category.categoriesModel.repositoryNotExists    = Image Repository path does not exist.
category.categoriesModel.repositoryNotAvailable = Image Repository is not available.
...
categrory.rename                    = Rename category
